...
function About() {
    return (
        <section id='about' className='site_container'>
            <h2 className='section_header'>About Our Restaurant</h2>
            <div className='banner_image'></div>
            <div className='content'>
                <h3 className='lato-bold'>Everything you need to know about 7 South Sandwich Company</h3>

                <h4 className='lato-bold'>Our Mission</h4>
                ...
                <h4 className='lato-bold'>Our Founder</h4>
                <div className='founder_headshot'></div>
                ...
                <h4 className='lato-bold'>Contact Us</h4>
                <a className='contact_link' href="https://maps.google.com/?saddr=Current+Location&daddr=1396+US-7,+Middlebury,+VT+05753/" target="_blank">1396 Rt 7 South Unit 4 Middlebury, VT 05753</a>
                <a className='contact_link' href="tel:802-388-3354">802-388-3354</a>
                <a className='contact_link' href="mailto:7southsandwichcompany@gmail.com">7southsandwichcompany@gmail.com</a>
